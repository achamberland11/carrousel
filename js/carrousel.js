(function(){
   ...
   let fleche__gauche = document.querySelector(".fleche__droite")
   let fleche__droite = document.querySelector(".fleche__gauche")
   ...
   fleche__gauche.addEventListener('mousedown', function(){
    //console.log('changer photo a gauche')
    for( const elm of galerie__img)
    {
      if(index <= 0){
  ...
  fleche__droite.addEventListener('mousedown', function(){
    //console.log('changer photo a droite')
    for( const elm of galerie__img)
    {
